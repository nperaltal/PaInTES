...
SRC=                                      \
	...
	../rtl/wb_ps2/wb_ps2.v             \
       	../rtl/wb_ps2/TopmodulePS2.v       \
       	../rtl/wb_ps2/CTRLps2.v            \
       	../rtl/wb_ps2/ps2.v                \
       	../rtl/wb_LCD/wb_LCD.v             \
       	../rtl/wb_LCD/ram_video.v          \
       	../rtl/wb_LCD/bloque0.v 	   \
       	../rtl/wb_LCD/bloque1.v		   \
       	../rtl/wb_LCD/bloque2.v		   \
       	../rtl/wb_LCD/bloque3.v		   \
       	../rtl/wb_LCD/bloque4.v		   \
       	../rtl/wb_LCD/CTRL_RAM.v	   \
       	../rtl/wb_LCD/SYNC.v		   \
       	../rtl/wb_LCD/SerCom_LCD.v	   \
...
system_tb.vvp:
	...
	cd simulation && $(IVERILOG) -o $@ $(VINCDIR) -c $@.list -s $(@:.vvp=) -s
